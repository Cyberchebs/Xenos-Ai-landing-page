        ...
        <div className="container">
          ...
          >
            {features.map(({ id, icon, caption, text, button, title }) => (
              <div
                key={id}
                className="relative z-2 md:px-10 px-5 md:pb-10 pb-5 flex-50 max-md:g7 max-md:border2 max-md:rounded-3xl max-md:flex-320"
              >
                <div className="w-full flex justify-start items-start">
                  <div className="-ml-3 mb-12 items-center justify-center flex-col">
                ...
                <p className="caption mb-5 max-mb:mb-6 ">{caption}</p>
