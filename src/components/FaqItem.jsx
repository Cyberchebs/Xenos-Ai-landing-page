    ...
    <div className="relative z-2 mb-16">
      ...
      >
        <div className="flex-1 ">
          ...
          <div
            className={clsx(
              "h6 text-p4 transition-colors max-md:flex max-mid:min-h-20 max-md:items-center",
      ...
      <div
        className={clsx(
          "g5 -bottom-7 -top-7 left-0 right-0 -z-1 rounded-3xl opacity-0 transition-opacity transition-500 absolute",
          active && "opacity-100"
        )}
      >
